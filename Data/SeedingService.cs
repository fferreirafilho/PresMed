...
namespace PresMed.Data {
    public class SeedingService {
        ...
        public void Seed() {
            ...
            Person p2 = new Person("Joao da Silva", 9223123372, "joaosilva@gmail.com", "88589476065", "18", "Centro", "GO", null, "Goianésia", "448", UserStatus.Ativo, PersonType.Doctor, "JSILVA", "123456798", "DF - 1234", "Clinico Geral", new DateTime(2000, 04, 16));
            ...
            //Person p5 = new Person("Jennifer Faida", 4724215048, "jenniferfaida@gmail.com", "68713358030", "01", "Bela Vista", "GO", null, "Goianésia", UserStatus.Ativo, PersonType.Doctor, "185", "JFAIDA", "123456798", "SC-1234", "Pediatra", new DateTime(1963, 11, 10));
